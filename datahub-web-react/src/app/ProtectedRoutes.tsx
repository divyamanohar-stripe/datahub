...
import { ManageUserDefinedReportsPage } from './userDefinedReport/ManageUserDefinedReportsPage';
            ...
            <Layout style={{ height: '100%', width: '100%' }}>
                <Layout>
                    <Switch>
                        ...
                        <Route path={PageRoutes.USER_DEFINED_REPORTS} render={() => <ManageUserDefinedReportsPage />} />
