...
export const EmbeddedListSearch = ({
    ...
    // todo(yyu): delete this when EmbeddedListSearchHeader is updated
    if (searchBarStyle && searchBarInputStyle && refetch && selectedEntityUrns && onChangeSelectAll) {
        setIsSelectMode(false);
        setNumResultsPerPage(SearchCfg.RESULTS_PER_PAGE);
    }
